...
export const zhCn = {
  ...
  wizard: {
    ...
    researchReelAnalyzed:
      "参考短片已分析 — 已按参考节奏排好分镜大纲；第 2 步用 Nano Banana 出场景图，第 3 步 Seedance 合成短片。",
    ...
    researchReelSetupIntroConcept:
      "选了热门短片之后：下载参考 MP4 → 分析节奏 → 第 2 步出场景图（可预览每格）→ 第 3 步按你选择的长度合成。避免盲按一次生成大片。",
    researchReelStatusPost: "已选参考帖",
    researchReelStatusMp4: "参考 MP4 已下载",
    researchReelMp4Missing:
      "参考 MP4 未下载 — 平台搜索可能暂时失败（COLLECT FAILED），请再搜索一次选帖。",
    ...
    researchReelUploadMp4Hint:
      "平台未自动下载到 MP4 时，可从小红书另存短片后在此上传，或再搜索选另一帖",
    ...
    conceptResearchReelStoryboardImagePreflight:
      "概念分镜：先看场景图再出片 — 比一次性参考短片生成更省钱、更少意外。",
    quickFixTitle: "快速小修（细节）",
    quickFixImageHint: "描述要改什么——我们会以目前这张图为基础，只改你要求的部分。",
    ...
    quickFixCreditReady: "此作品尚有 {count} 次快速小修额度。",
    ...
    referenceConceptStyleOnlyHint:
      "已上传风格参考 — 会把参考图直接送给 Nano Banana（跟色调、字体氛围），用步骤 1 的主标/副标做新 layout。要跟真产品合成请在步骤 1 加主体图。",
