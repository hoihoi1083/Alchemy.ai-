...
export const zhCn = {
  ...
  wizard: {
    ...
    workflowModes: {
      ...
      "video-only": {
        title: "只要影片",
        description: "产品相 → Seedance Reels（可选参考片）",
      },
      combined: {
        title: "先要相片，再要影片",
        description: "Nano Banana 2 宣传图 → Seedance 动态 — 两样都有",
      },
    },
    ...
    quickFixCreditUsed: "快速小修额度已用完；再生成会使用正常费用。",
    ...
    promptMarkets: {
      hk: { label: "香港 / 粤语市场", hint: "港式店舖、都市感、SMB 广告" },
    ...
    sublineBulletsPlaceholder: "能量频率\n个人连结\n真假辨别",
  ...
  pro: {
    back: "← 返回",
    title: "进阶工具",
    body: "完整功能（参考影片 AI、成本预设、粤语字幕）暂时喺原本 app：",
    footnote: "之后会搬嚟呢度。",
  },
} as const;
