...
export const zh = {
  ...
  wizard: {
    ...
    researchReelAnalyzed:
      "參考短片已分析 — 已按參考節奏排好分鏡大綱；第 2 步用 Nano Banana 出場景圖，第 3 步 Seedance 合成短片。",
    ...
    researchReelSetupIntroConcept:
      "揀咗熱門短片之後：下載參考 MP4 → 分析節奏 → 第 2 步出場景圖（可預覽每格）→ 第 3 步按你揀嘅長度合成。唔使盲撳一次過生成長片。",
    researchReelStatusPost: "已揀參考帖",
    researchReelStatusMp4: "參考 MP4 已下載",
    researchReelMp4Missing:
      "參考 MP4 未下載 — 平台搜尋可能暫時失敗（COLLECT FAILED），請再搜尋一次揀帖。",
    ...
    researchReelUploadMp4Hint:
      "平台未自動下載到 MP4 時，可從小紅書另存短片後在此上傳，或再搜尋揀另一帖",
    ...
    conceptResearchReelStoryboardImagePreflight:
      "概念分鏡：先睇場景圖再出片 — 比一次過參考短片生成更慳錢、更少意外。",
    ...
    referenceConceptStyleOnlyHint:
      "已上傳風格參考 — 會把參考圖直接送俾 Nano Banana（跟色調、字體氛圍），用步驟 1 嘅主標／副標做新 layout。要跟真產品合成請喺步驟 1 加主體圖。",
