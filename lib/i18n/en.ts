...
export const en = {
  ...
  wizard: {
    ...
    researchReelAnalyzed:
      "Reference reel analyzed — storyboard plan ready from video beats. Step 2: Nano Banana scene stills. Step 3: Seedance stitches them.",
    ...
    researchReelSetupIntroConcept:
      "After picking a trending reel: download MP4 → analyze beats → Step 2 scene stills (preview each) → Step 3 stitch video at your chosen length. Avoid one expensive blind render.",
    researchReelStatusPost: "Reference post selected",
    researchReelStatusMp4: "Reference MP4 downloaded",
    researchReelMp4Missing:
      "Reference MP4 missing — platform search may have failed temporarily (COLLECT FAILED). Search again and pick another post.",
    ...
    researchReelUploadMp4Hint:
      "If the platform did not download an MP4, save the reel from the app and upload here, or search again",
    ...
    referenceStrategyKind: {
      none: "No reference",
      styleOnly: "Style inspiration (text)",
    ...
    conceptResearchReelStoryboardImagePreflight:
      "Concept storyboard: review scene stills before Seedance — lower cost and fewer surprises than one-shot reference video.",
    ...
    referenceConceptStyleOnlyHint:
      "Style reference uploaded — the image is sent directly to Nano Banana (palette + typography mood); Step 1 copy drives new layouts. Add a product photo in Step 1 to composite your SKU.",
